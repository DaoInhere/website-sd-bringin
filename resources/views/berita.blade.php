    ...
    <section class="mx-auto mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="card relative group rounded-2xl bg-white shadow-lg overflow-hidden">
                <img
                    src="{{ asset('asset/gambarFutsal.png') }}"
                    alt="Berita 1"
                ...
                <div class="absolute bottom-5 left-5 right-5 p-5 text-white opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-lg font-bold text-white">Judul Berita 1</h3>
                    <p class="text-sm mt-2">Label: Berita</p>
                    <a href="#" class="mt-4 inline-block bg-sekolah-hijau hover:bg-sekolah-hijau-dark text-white py-2 px-4 rounded-full" onclick="openModal('Berita 1', 'Ini adalah isi dari berita pertama. Berita ini sangat panjang dan berisi informasi yang bermanfaat bagi siswa dan guru SD Negeri Bringin.');">
                        Baca Selengkapnya
                    </a>
                </div>
            </div>
            ...
            <div class="card relative group rounded-2xl bg-white shadow-lg overflow-hidden">
                ...
                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition duration-300"></div>
                <div class="absolute bottom-5 left-5 right-5 p-5 text-white opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-lg font-bold text-white">Judul Berita 2</h3>
                    <p class="text-sm mt-2">Label: Pengumuman</p>
                    <a href="#" class="mt-4 inline-block bg-sekolah-hijau hover:bg-sekolah-hijau-dark text-white py-2 px-4 rounded-full" onclick="openModal('Berita 2', 'Ini adalah isi dari berita kedua. Berita ini menginformasikan tentang pengumuman penting terkait kegiatan sekolah.');">
                        Baca Selengkapnya
                    </a>
                </div>
            </div>
            ...
            <div class="card relative group rounded-2xl bg-white shadow-lg overflow-hidden">
                ...
                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition duration-300"></div>
                <div class="absolute bottom-5 left-5 right-5 p-5 text-white opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-lg font-bold text-white">Judul Berita 3</h3>
                    <p class="text-sm mt-2">Label: Berita</p>
                    <a href="#" class="mt-4 inline-block bg-sekolah-hijau hover:bg-sekolah-hijau-dark text-white py-2 px-4 rounded-full" onclick="openModal('Berita 3', 'Ini adalah isi dari berita ketiga. Berita ini memberikan informasi terkait dengan acara yang akan datang.');">
                        Baca Selengkapnya
                    </a>
                </div>
            </div>
