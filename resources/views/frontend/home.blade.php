            ...
            <div class="h-full overflow-hidden">
                <div id="slider-track" class="flex h-full transition-transform duration-700 ease-in-out">
                    @if ($herobanners->isEmpty())
                        <div
                            class="slide min-w-full relative h-full bg-cover bg-center flex items-center justify-center bg-gray-200">
                            ...
                            <div class="slide min-w-full relative h-full bg-cover bg-center"
                                ...
                                <div class="absolute inset-0 flex items-center justify-center text-center px-4">
                                    <div class="max-w-4xl">
                                        ...
                                        <h3
                                            class="text-sekolah-hijau-light font-bold tracking-widest uppercase mb-2 text-lg md:text-xl">
                                            {{ $herobanner->title }}
                                        </h3>

                                        <h1
                                            class="text-white text-4xl md:text-6xl font-bold mb-8 leading-tight drop-shadow-md">
                                            {{ $herobanner->subtitle }}
                                        </h1>
                                    </div>
                                </div>
        ...
        <section class="relative -mt-16 z-20 px-4">
            <div class="mx-auto max-w-7xl overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-3 shadow-2xl rounded-2xl overflow-hidden hover:bg-sekolah-kuning">
                    <div
                        class="bg-sekolah-hijau-light p-10 text-white text-center hover:-translate-y-2 transition duration-300">
                    ...
                    <div
                        class="bg-sekolah-hijau-dark p-10 text-white text-center hover:-translate-y-2 transition duration-300">
        ...
        <section class="py-20 bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row items-center justify-center gap-10 lg:gap-14">
                    <div class="md:w-5/12">
                        <h4
                            class="text-3xl font-bold text-sekolah-hijau mb-4 border-b-4 border-sekolah-kuning inline-block pb-2">
                        ...
                        <div class="text-gray-600 leading-relaxed text-justify space-y-4">
                            ...
                            <p>Salam sehat, salam semangat untuk kita semua. Puji Syukur kami panjatkan kehadirat Allah Swt
                                atas segala limpahan rahmat dan karunia-Nya, sehingga SD Negeri Bringin 01 berhasil
                                membangun website sekolah.</p>
                            <p>Kehadiran website SD Negeri Bringin 01 diharapkan dapat memudahkan penyampaian informasi
                                secara terbuka kepada warga sekolah, alumni, dan masyarakat serta instansi lain yang
                                terkait.</p>
                            <p>Di era global dan pesatnya teknologi informasi dan komunikasi ini, tidak dipungkiri bahwa
                                keberadaan website untuk suatu organisasi, termasuk SD Negeri Bringin 01 sangatlah penting.
                            </p>
                            <p>Oleh karena itu, kami sangat berharap, melalui website ini SD Negeri Bringin 01 akan semakin
                                berkembang lebih maju dan solid. Terimakasih.</p>
                    ...
                    <div class="md:w-5/12 flex justify-center">
                        <div class="relative rounded-2xl overflow-hidden shadow-xl inline-block group bg-gray-50">
                            <img src="{{ $headmaster ? $headmaster->photo_url : asset('asset/nophoto.png') }}"
                                alt="foto Kepala Sekolah"
                                class="max-h-96 w-full object-contain transition-transform duration-500 group-hover:scale-105">

                            <div
                                class=" absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm p-3 rounded-xl shadow-md border-l-4 border-sekolah-kuning">
                                <p class="font-bold text-gray-800 text-base">{{ $headmaster ? $headmaster->name : 'Foto' }}
                                </p>
        ...
        <section class="py-20 bg-gray-50">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-600 mt-4 max-w-2xl mx-auto">Kami menyediakan berbagai program untuk mendukung minat
                        dan bakat siswa.</p>
                </div>
                ...
                @else
                    <div>
                        <div class="grid gap-8 justify-center grid-cols-[repeat(auto-fit,minmax(150px,250px))]">
                            @foreach ($extracurriculars as $extracurricular)
                                <div
                                    class="bg-white overflow-hidden p-8 rounded-2xl shadow-md hover:shadow-xl transition hover:-translate-y-2 border-b-4 border-white hover:border-sekolah-kuning group">
                                    <div
                                        class="w-[200px] h-[200px] overflow-hidden rounded-full bg-sekolah-hijau/10 flex items-center justify-centermx-auto transition group-hover:bg-sekolah-hijau">
                                        <img src="{{ $extracurricular->image_url }}"
                                            class="w-full h-full object-cover rounded-full">
                                    </div>
                                    <div class="mt-4">
                                        <h3 class="text-xl font-bold text-center mb-3">{{ $extracurricular->subject }}</h3>
                                        <p class="text-gray-600 text-center text-sm">{{ $extracurricular->description }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
        ...
        <section class="py-20 bg-white border-t border-gray-100">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-600 mt-4">Alasan kenapa harus memilih kami sebagai tempat belajar putra-putri Anda.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <div class="relative rounded-2xl overflow-hidden shadow-xl mb-6 group">
                            <img src="{{ asset('asset/sekolah sd bringin 01 semarang.jpg') }}" alt="Gedung Sekolah"
                        ...
                        <div class="flex items-start text-gray-500 text-sm mb-4">
                            ...
                            <p>Jl. Bringin Raya No. 123, Kelurahan Ngaliyan, Kecamatan Ngaliyan, Kota Semarang, Jawa Tengah
                            </p>
                        </div>

                        <p class="text-gray-600 text-sm leading-relaxed border-l-4 border-sekolah-kuning pl-4 italic">
                            "SD Negeri 1 Bringin merupakan sekolah dasar unggulan yang fokus pada pengembangan hasil belajar
                            siswa secara holistik demi mewujudkan Profil Pelajar Pancasila."
                        </p>
                    </div>
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-6 group">
                            <div
                                class="flex-shrink-0 w-20 h-20 bg-sekolah-hijau rounded-2xl flex items-center justify-center text-white text-3xl shadow-lg group-hover:bg-sekolah-hijau-dark transition duration-300">
                                <i class="fas fa-chalkboard-teacher"></i>
                            </div>
                            <div>
                                <h4 class="text-lg font-bold text-gray-800 mb-2 group-hover:text-sekolah-hijau transition">
                                    Guru & Tenaga Pendidik Profesional</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Dididik oleh guru-guru bersertifikat pendidik, berpengalaman, ramah anak, dan
                                    berdedikasi tinggi dalam membimbing siswa sesuai Kurikulum Merdeka.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-6 group">
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-gray-800 mb-2 group-hover:text-sekolah-hijau transition">
                                    Fasilitas Lengkap & Modern</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Dilengkapi laboratorium komputer, perpustakaan nyaman, ruang kelas multimedia, mushola,
                        ...
                        <div class="flex gap-6 group">
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-gray-800 mb-2 group-hover:text-sekolah-hijau transition">
                                    Pengembangan Karakter Unggul</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Fokus pada pembentukan karakter siswa yang beriman, mandiri, kreatif, dan bergotong
                                    royong melalui berbagai kegiatan pembiasaan positif.
                                </p>
                            </div>
                        </div>
                    </div>
