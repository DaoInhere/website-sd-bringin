                ...
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse border border-gray-300">
                        <thead class="bg-gray-100 text-gray-700">
                            <tr>
                                <th class="border border-gray-300 p-3 text-center">Gambar</th>
                                <th class="border border-gray-300 p-3 text-left">Judul</th>
                                <th class="border border-gray-300 p-3 text-left">Sub Judul</th>
                                <th class="border border-gray-300 p-3 text-left">Banner Redup</th>
                            ...
                            @forelse ($herobanners as $herobanner)
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    <td class="border border-gray-300 p-3 text-center">
                                        <img src="{{ $herobanner->image_url }}" class="w-24 h-24 object-cover mx-auto rounded shadow-sm">
                                    </td>
                                    ...
                                    <td class="border border-gray-300 p-3">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form action="{{ route('herobanners.destroy', $herobanner->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin hapus banner ini?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
